...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (theme === 'catppuccin' || theme === 'spooky' || theme === 'winter' || theme === 'slack') {
  ...
  themeRadios.forEach(radio => {
    radio.addEventListener('change', async (e) => {
      ...
      settingsDiv.style.display = (selectedTheme === 'catppuccin' || selectedTheme === 'spooky' || selectedTheme === 'winter' || selectedTheme === 'slack') ? 'block' : 'none';
